...
public class MyJobsCancelledFragment extends Fragment implements AdapterCallback, View.OnClickListener, OnCallBack {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapterCallback = MyJobsCancelledFragment.this;
        return view;
    }
    ...
    private void getPostedTaskList(final String category_ids, final String replaceArrayListCategorys, final String value_date_filters) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConstant.API_GET_VENDOR_JOB_LISTING,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Log.i("Response", "CancelList :" + response);
            ...
            protected Map<String, String> getParams() {
                ...
                try {
                    ...
                    params.put("sub_category_id", replaceArrayListCategorys);
                    params.put("fdt", value_date_filters);
