...
public class UserLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(UserLoginActivity.this);
        ...
        btn_createaccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(UserLoginActivity.this, UserRegistrationActivityStepOne.class);
        ...
        btn_signIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (checkValidation1()) {
                    ...
                    if (Utils.isNetworkAvailable(UserLoginActivity.this)) {
                        ...
                        Utils.myToast1(UserLoginActivity.this);
                    }
                }
            }
        });
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConstant.API_LOGIN_USER,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        String reason = AppUtils.getVolleyError(UserLoginActivity.this, error);
                        AlertUtility.showAlert(UserLoginActivity.this, reason);
