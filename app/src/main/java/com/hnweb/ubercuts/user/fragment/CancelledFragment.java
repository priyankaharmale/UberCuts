...
public class CancelledFragment extends Fragment implements View.OnClickListener {
    ...
    private ArrayList<MyTaskModel> myTaskModels = null;
            ...
            public void OnDataReceived(String data) {
                ...
                try {
                    ...
                    if (message_code == 1) {
                        ...
                        myTaskModels = new ArrayList<MyTaskModel>();
